...
COMMON_PRINTS = {
    ...
    "outdoor_clip": {"name": "Outdoor clip", "emoji": "", "purpose": "functional", "size": "small", "priority": "balanced", "filament": "ASA", "notes": "ASA handles UV and rain — the only outdoor filament.", "printer": "bedslinger"},
    ...
    "enclosure": {"name": "Electronics enclosure", "emoji": "", "purpose": "functional", "size": "medium", "priority": "strongest", "filament": "ABS", "notes": "ABS handles heat from electronics safely.", "printer": "bedslinger"},
    ...
    "rc_part": {"name": "RC car body part", "emoji": "", "purpose": "functional", "size": "medium", "priority": "strongest", "filament": "PLA+", "notes": "PLA+ gives good impact resistance for RC parts.", "printer": "bedslinger"},
    ...
    "architectural_model": {"name": "Architectural model", "emoji": "", "purpose": "visual", "size": "large", "priority": "smoothest", "filament": "PLA", "notes": "Fine detail at 0.1mm layers for presentation models.", "printer": "corexY"},
    "cable_chain": {"name": "Cable chain", "emoji": "", "purpose": "functional", "size": "medium", "priority": "strongest", "filament": "PETG", "notes": "PETG survives repeated flexing without cracking.", "printer": "bedslinger"},
...
TROUBLESHOOTING = {
    "warping": {"problem": "Print lifting off bed or warping at corners", "emoji": "", "causes": ["Bed not level", "Bed temp too low", "No brim", "Cooling too high for first layers", "Damp filament"], "fixes": ["Level your bed carefully", "Increase bed temp by 5C", "Add 8mm brim in slicer", "Turn fan off for first 3 layers", "Dry your filament"]},
    "stringing": {"problem": "Thin strings of plastic between parts", "emoji": "", "causes": ["Retraction too low", "Temp too high", "Travel speed too slow", "Wet filament"], "fixes": ["Increase retraction by 0.5mm steps", "Lower temp by 5C", "Increase travel speed to 150mm/s", "Enable combing mode", "Dry filament overnight"]},
...
FAILURE_GALLERY = [
    ...
    {"name": "Layer shifting", "emoji": "", "description": "Layers suddenly shift to one side mid-print making the object look like it's been pushed sideways.", "causes": ["Print speed too fast", "Loose belts or pulleys", "Extruder hitting print or brim", "Electrical interference"], "fixes": ["Reduce print speed by 30%", "Check and tension all belts", "Check for obstructions on bed", "Check stepper motor connections"], "prevention": "Regularly check belt tension and print at appropriate speeds for your printer."},
    {"name": "Stringing / spider web", "emoji": "", "description": "Thin strings of plastic connecting different parts of the print like a spider web.", "causes": ["Retraction too low", "Temperature too high", "Travel speed too slow", "Wet filament"], "fixes": ["Increase retraction by 0.5mm steps", "Lower temperature by 5C", "Increase travel speed", "Enable combing mode in slicer"], "prevention": "Store filament sealed with silica gel and tune retraction for each filament brand."},
    {"name": "Warping / lifting corners", "emoji": "", "description": "Corners of the print lift off the bed during printing, sometimes causing the whole print to detach.", "causes": ["Bed too cold", "No brim used", "Filament shrinks too much on cooling", "Drafts near printer"], "fixes": ["Increase bed temperature", "Add 8mm+ brim", "Use enclosure for ABS/ASA", "Move printer away from fans/windows"], "prevention": "Use PEI sheet, correct bed temperatures, and always add brim for large or ABS prints."},
...
PRINTER_CHECKLIST = [
    ...
    {"step": 5, "title": "Calibrate Z offset", "emoji": "", "tasks": ["Start a first layer calibration print", "Watch first layer carefully — should be slightly squished", "Too far: filament not bonding, gaps between lines", "Too close: filament smearing, nozzle scraping", "Adjust in 0.05mm steps until first layer looks perfect"]},
    {"step": 6, "title": "First print", "emoji": "", "tasks": ["Download a simple calibration cube from Thingiverse", "Use recommended settings for your filament (use OptimalPrint!)", "Watch the entire first layer before walking away", "Check for any unusual sounds or smells", "Measure the printed cube — should be within 0.2mm of 20mm"]},
